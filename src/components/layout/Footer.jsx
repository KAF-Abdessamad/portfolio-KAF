...
export default function Footer() {
    ...
    const handleScroll = (e, targetId) => {
        ...
        if (element) {
            ...
            window.location.href = `/${targetId.startsWith('#') ? targetId : '#' + targetId}`;
        }
    };
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            <li><a href="/" onClick={(e) => handleScroll(e, 'hero')} className="text-text-secondary hover:text-text-accent transition-colors">{t('nav.home')}</a></li>
                            <li><a href="#projects" onClick={(e) => handleScroll(e, 'projects')} className="text-text-secondary hover:text-text-accent transition-colors">{t('nav.projects')}</a></li>
                            <li><a href="#contact" onClick={(e) => handleScroll(e, 'contact')} className="text-text-secondary hover:text-text-accent transition-colors">{t('nav.contact')}</a></li>
                        </ul>
                    </div>
